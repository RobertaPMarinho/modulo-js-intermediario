...
function aumentarFonteSegundoPost() {
  ...
  textoPosts[1].classList.add('fonte-grande'); // Para acessar a lista de classes de determinado elemento utilizamos o método classList. Para adicionar elementos à essa lista, utilizamos o método add
}
